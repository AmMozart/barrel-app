...
const Settings = (props) => {
  return (
    <div className={style.general}>
      ...
      <ChangeButton
        text="Ручной"
        onClick={props.setTengModeMANUAL}
        isActive={props.tengMode === "MANUAL"}
      />
      <ChangeButton
        text="Выключен"
        onClick={props.setTengModeOFF}
        isActive={props.tengMode === "OFF"}
      />
      <ChangeButton
        text="Авто"
        onClick={props.setTengModeAUTO}
        isActive={props.tengMode === "AUTO"}
      />

      <h2> Активные тены </h2>
      <TableTeng
        setDayTeng={props.setDayTeng}
