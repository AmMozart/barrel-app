...
const TablePrice = ((props) => {
  return (
      <div className={style.energyPrice}>
        ...
        <div className={style.checkbox1}><input type='checkbox'></input></div>
        ...
        <div className={style.checkbox2}><input type='checkbox'></input></div>
        ...
        <div className={style.checkbox3}><input type='checkbox'></input></div>
        ...
        <div className={style.checkbox4}><input type='checkbox'></input></div>
