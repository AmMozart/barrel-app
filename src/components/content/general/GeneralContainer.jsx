...
let mapDispatchToProps = (dispatch) => {
  return {
    setPowerModeON: () => dispatch({ type: SET_POWER_MODE, data: "ON" }),
    setPowerModeOFF: () => dispatch({ type: SET_POWER_MODE, data: "OFF" }),
    setPowerModeAUTO: () => dispatch({ type: SET_POWER_MODE, data: "AUTO" }),
    setTempModeMANUAL: () => dispatch({ type: SET_TEMP_MODE, data: "MANUAL" }),
    setTempModeAUTO: () => dispatch({ type: SET_TEMP_MODE, data: "AUTO" }),
    setWaterFlow: (data) => dispatch({ type: SET_WATER_FLOW, data: data }),
