...
const TempMode = props => {
  return (
    <div className={style.general}>
      ...
      <ChangeButton text='Ручной' onClick={props.setTempModeMANUAL} isActive={props.tempMode === 'MANUAL'} />
      <ChangeButton text='Авто' onClick={props.setTempModeAUTO} isActive={props.tempMode === 'AUTO'} />
    </div>
  );
};
